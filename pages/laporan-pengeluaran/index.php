<?php
$title = 'Laporan Pengeluaran'; // set the variable before including
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="get" class="row g-3" id="laporanForm">
                    <input type="hidden" name="page" value="laporan-pengeluaran">
                    <div class="col-md-6">
...
<div class="row mt-3">
    <div class="col-12">
        <div class="card shadow-none">
            <div class="row">
                <div class="col-12">
                    <h4 class="text-center mt-3 "><b>PAMSIMAS</b><br><b>Laporan Pengeluaran</b></h4>
            ...
            <div class="card-body">
                ...
                <table id="table-data" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM vw_laporan_pengeluaran $whereClause ORDER BY tanggal DESC";
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>
                                ...
                                $sql = "SELECT SUM(jumlah) AS total_pengeluaran FROM vw_laporan_pengeluaran $whereClause";
                                $result = $conn->query($sql);
                                $row = $result->fetch_assoc();
                                echo number_format($row['total_pengeluaran'], 0, ',', '.');
                                ?>
                            </th>
                        </tr>
                    </tfoot>
